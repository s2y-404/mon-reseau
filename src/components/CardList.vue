...
<template>
    <div v-if="!this.dataList.length || !this.arrayFilter.length" class="d-flex justify-content-center align-items-center my-5">
      <svg xmlns="http://www.w3.org/2000/svg" data-name="Layer 1" width="372.5315" height="438.39398" viewBox="0 0 672.5315 738.39398" xmlns:xlink="http://www.w3.org/1999/xlink">
          <g class="animate__animated animate__fadeInTopLeft animate__slow">
          ...
          <g class="animate__animated animate__fadeOutUp animate__slow animate__delay-4s">
          ...
          <g class="animate__animated animate__fadeInDown animate__faster animate__delay-3s">
          ...
          <g class="animate__animated animate__shakeY animate__slow">
